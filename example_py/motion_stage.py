...
def get_angle_state_flatten(state):
    return [state.motorState[d['FR_0']].q, state.motorState[d['FR_1']].q, state.motorState[d['FR_2']].q, 
...
def get_ang_vel_flatten(state):
    return [state.motorState[d['FR_0']].dq, state.motorState[d['FR_1']].dq, state.motorState[d['FR_2']].dq, 
            state.motorState[d['FL_0']].dq, state.motorState[d['FL_1']].dq, state.motorState[d['FL_2']].dq,
            state.motorState[d['RR_0']].dq, state.motorState[d['RR_1']].dq, state.motorState[d['RR_2']].dq,
            state.motorState[d['RL_0']].dq, state.motorState[d['RL_1']].dq, state.motorState[d['RL_2']].dq]
